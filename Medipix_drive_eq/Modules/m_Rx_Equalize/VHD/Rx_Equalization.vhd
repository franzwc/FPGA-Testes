...
begin
	if (In_Rst='1') then
		...
		if (((reg_Port_byte2="0010")or(reg_Port_byte2="0010"))and((reg_Port_byte3="1000")or(reg_Port_byte3="1011")or(reg_Port_byte3="0010")))then--(reg_Port_byte1="0010")and(reg_Port_byte2="0010")and(reg_Port_byte3="1000")and(reg_Port_byte4="1011")
			if (v_conta_byte=1)then
				v_conta_pkt := v_conta_pkt+1;
			elsif(v_conta_pkt>385)then
				v_conta_pkt := 1;
			end if;
