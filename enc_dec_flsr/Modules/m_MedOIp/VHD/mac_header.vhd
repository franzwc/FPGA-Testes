...
port(
	...
	i_ts_PacketLength		: in integer range 0 to 1400;
...
variable v_nPkt						: integer range 0 to 1024;
...
variable v_nPkt_aux					: integer range 0 to 1024;
...
--------------------------------------------------------------------------------
	...
	if v_ChangeParameters_ctrl ='0' then
		v_MacDest_aux	         :=i_MacDest;--x"000000000000";		
	...
	v_total_length := std_logic_vector(to_unsigned(((i_ts_PacketLength)+28),16));
	...
	--Destination Port
		...
		v_total_length_aux := std_logic_vector(to_unsigned(((i_ts_PacketLength)+8),16));
