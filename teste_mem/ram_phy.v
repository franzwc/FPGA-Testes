...
module ram_phy (
	...
	ram_phy_alt_mem_phy	ram_phy_alt_mem_phy_inst(
	...
	defparam
		ram_phy_alt_mem_phy_inst.FAMILY = "Cyclone IV E",
		ram_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		ram_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		ram_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		ram_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		ram_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		ram_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		ram_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		ram_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		ram_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		ram_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		ram_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 3,
		ram_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		ram_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		ram_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		ram_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		ram_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		ram_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		ram_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		ram_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		ram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 8000,
		ram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "8000 ps",
		ram_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 594,
		ram_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1092,
		ram_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		ram_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		ram_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 80,
		ram_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		ram_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		ram_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		ram_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		ram_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="ram_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "speed_grade" value="8L"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="ram_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ram_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ram_phy_alt_mem_phy_seq_wrapper;+ram_phy_alt_mem_phy_reconfig;+ram_phy_alt_mem_phy_pll;+ram_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\franz.couto\Desktop\Prototipo_Medipix\Projeto\teste_mem/ram_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="ram_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "quartus_settings">
// Retrieval info:      <PRIVATE name = "DEVICE" value="EP4CE75F23C8"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "FAMILY" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
