      ...
      wire                 sig_Clk_Mdpx_OMR;
	   ...
	   assign  Out_M = w_out_M;
		...
		Select_Output u_Select_Output (
				...
				.In_Clk_Mdpx_LCH                              (sig_Clk_Mdpx_LCH|sig_Clk_Mdpx_LCL),
				.In_Data_Mdpx_LCH                             (sig_Data_Mdpx_LCH|sig_Data_Mdpx_LCL),
				.In_En_Mdpx_LCH                               (sig_En_Mdpx_LCH&sig_En_Mdpx_LCL),
		...
		Gera_Rajada_Load_CounterL u_Gera_Rajada_Load_CounterL (
		      ...
		      .In_Reset                                      (In_Reset),
				.In_Clk                                        (In_Clk_nios),
				.In_Send                                       (w_send_lcl),//|w_send_lcl_h
